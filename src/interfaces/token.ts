...
export function isAccountData(
  accountData: any
): accountData is AccountData {
  return (
    accountData.legal_entity || accountData.tos_shown_and_accepted
  );
}

export function isBankAccount(bankAccount: any): bankAccount is BankAccount {
