  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () => import('./docs/payment-element/payment-element.module').then(m => m.NgStrPaymentElementModule),
        data: { title: 'Payment Element' }
      },
      {
        path: 'element-components',
        loadChildren: () => import('./docs/element-components/element-components.module').then(m => m.NgStrElementComponentsModule),
        data: { title: 'Elements' }
      },
      {
        path: 'identity',
      ...
      },
      {
        ...
        loadChildren: () => import('./docs/payment-request-button/payment-request-button.module').then(m => m.NgStrPaymentRequestButtonModule),
      ...
      },
      {
        ...
        loadChildren: () => import('./docs/service-factory/service-factory.module').then(m => m.NgStrServiceFactoryModule),
        data: { title: 'Stripe Factory' }
      },
      {
        path: 'reference-instance',
        loadChildren: () => import('./docs/reference-instance/reference-instance.module').then(m => m.NgStrReferenceInstanceModule),
        data: { title: 'Reference Instance' }
      },
      {
        path: 'manually-mount-your-element',
        loadChildren: () => import('./docs/manually-mount/manually-mount.module').then(m => m.NgStrManuallyMountModule),
