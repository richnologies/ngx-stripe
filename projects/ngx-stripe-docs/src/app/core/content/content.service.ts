...
export class NgStrContentService {
  ...
  menu: NgStrMenuItem[] = [
    ...
    { group: 'Getting Started', type: 'page', name: 'Installation', path: 'installation' },
    { group: 'Getting Started', type: 'page', name: 'Setup Application', path: 'setup-application' },
    { group: 'Core Concepts', type: 'group', name: 'Core Concepts' },
    { group: 'Core Concepts', type: 'page', name: 'Checkout', path: 'checkout' },
    { group: 'Core Concepts', type: 'page', name: 'Payment Element', path: 'payment-element' },
    { group: 'Core Concepts', type: 'page', name: 'Element Components', path: 'element-components' },
    { group: 'Core Concepts', type: 'page', name: 'Identity', path: 'identity' },
    { group: 'Core Concepts', type: 'page', name: 'Payment Request Button', path: 'payment-request-button' },
    { group: 'Core Concepts', type: 'page', name: 'Service', path: 'service' },
    { group: 'Core Concepts', type: 'page', name: 'Styling', path: 'styling' },
    { group: 'Core Concepts', type: 'page', name: 'Service Factory', path: 'service-factory' },
    { group: 'Core Concepts', type: 'page', name: 'Reference & Instance', path: 'reference-instance' },
    { group: 'Core Concepts', type: 'page', name: 'Mount your Element', path: 'manually-mount-your-element' },
