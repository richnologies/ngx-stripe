...
@Component({
  ...
  template: `
    <div #sectionContainer class="flex-1 justify-center relative z-0 flex h-screen overflow-y-auto">
      <main class="flex-1 m-auto py-10 max-w-screen-md h-full w-11/12 my-0 mx-1 max-w-2xl">
